...
FIELD_MAP = {
    ...
    "대수": "RASMBLY_NUMPR", "제안대수": "RASMBLY_NUMPR",
    ...
    "의안 번호": "BI_NO", "의안번호": "BI_NO", "의안 관리번호": "BI_NO",
    "의안명": "BI_SJ", "의안 명": "BI_SJ", "의안제목": "BI_SJ",
    "의안 제목": "BI_SJ", "제목": "BI_SJ",
    "의안 종류": "BI_KND_NM", "의안종류": "BI_KND_NM", "의안 구분": "BI_KND_NM",
    "의안구분": "BI_KND_NM", "의안 유형": "BI_KND_NM", "의안유형": "BI_KND_NM",
    "주요 내용": "BI_OUTLINE", "주요내용": "BI_OUTLINE", "의안 요지": "BI_OUTLINE",
    "의안요지": "BI_OUTLINE", "처리 요지": "BI_OUTLINE", "처리요지": "BI_OUTLINE",
    "결과 요지": "BI_OUTLINE", "결과요지": "BI_OUTLINE", "철회요지": "BI_OUTLINE",
    "이송일": "TRNSF_DE", "집행부 이송일": "TRNSF_DE",
    "자치단체 이송일": "TRNSF_DE", "자치단체이송일": "TRNSF_DE", "집행기관 이송일": "TRNSF_DE",
    "철회일": "RETRAC_DE", "철회일자": "RETRAC_DE",
    "비고": "REMARK",
    "첨부파일": "BI_FILE_NM", "첨부": "BI_FILE_NM", "의안파일": "BI_FILE_NM",
    "의안원문": "BI_FILE_NM", "원안": "BI_FILE_NM", "접수의안": "BI_FILE_NM",
    "심의안건": "BI_FILE_NM", "발의(제출)안": "BI_FILE_NM",
    "제안안(원안)": "BI_FILE_NM", "의안": "BI_FILE_NM", "관련자료": "BI_FILE_NM", "회의록보기": "BI_FILE_NM", "보고서": "BI_FILE_NM",
    "첨부파일링크": "BI_FILE_URL",
    "접수일": "PLNMT_FRWRD_DE", "접수일자": "PLNMT_FRWRD_DE", "심사보고접수일": "PLNMT_FRWRD_DE",
    ...
    "처리 결과": "PLNMT_RESULT", "처리결과": "PLNMT_RESULT", "처리상태": "PLNMT_RESULT",
